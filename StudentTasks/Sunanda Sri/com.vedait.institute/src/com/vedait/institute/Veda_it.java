...
public class Veda_it {
	...
	public static void main(String[] args) {
		...
		Students student1 = new Students("Sunanda","sunanda@gmail.com",'F',9344865900l,1215,"FS java",16000);
		Students student2 = new Students("Kavitha","kavitha@gmail.com",'F',9784486904l,1209,"FS java",16000);
		Students student3 = new Students("Satya","satya@gmail.com",'F',7036155625l,1211,"java",5000);
		Students student4 = new Students("sindhu","sindhu@gmail.com",'F', 7937233651l,1215,"FS python",20000);
		Students student5 = new Students("Ramya","ramya@gmail.com",'F',8307698325l,1207,"UI/UX",25000);
